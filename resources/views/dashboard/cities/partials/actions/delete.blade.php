        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title-{{ $city->id }}">@lang('cities.dialogs.delete.title')</h5>
                ...
                <div class="modal-footer">
                    {{ BsForm::delete(route('dashboard.countries.cities.destroy', [$city->country, $city])) }}
